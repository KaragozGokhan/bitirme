INSERT INTO users (first_name, last_name, email, password_hash, role, subscription_type, subscription_end_date) VALUES
('Ahmet', 'Yılmaz', 'ahmet@example.com', '$2a$10$randomhash1', 'user', 'premium', '2024-12-31'),
('Ayşe', 'Demir', 'ayse@example.com', '$2a$10$randomhash2', 'user', 'free', NULL),
('Mehmet', 'Kaya', 'mehmet@example.com', '$2a$10$randomhash3', 'user', 'premium', '2024-06-30'),
('Zeynep', 'Arslan', 'zeynep@example.com', '$2a$10$randomhash4', 'user', 'free', NULL),
('Ali', 'Yıldız', 'ali@example.com', '$2a$10$randomhash5', 'user', 'premium', '2024-09-30'),
('Fatma', 'Çelik', 'fatma@example.com', '$2a$10$randomhash6', 'user', 'free', NULL),
('Mustafa', 'Şahin', 'mustafa@example.com', '$2a$10$randomhash7', 'user', 'premium', '2024-12-31'),
('Elif', 'Öztürk', 'elif@example.com', '$2a$10$randomhash8', 'user', 'free', NULL),
('Can', 'Ak', 'can@example.com', '$2a$10$randomhash9', 'user', 'premium', '2024-06-30'),
('Seda', 'Yılmaz', 'seda@example.com', '$2a$10$randomhash10', 'user', 'free', NULL),
('Burak', 'Yılmaz', 'burak@example.com', '$2a$10$randomhash11', 'user', 'premium', '2024-09-30'),
('Deniz', 'Kaya', 'deniz@example.com', '$2a$10$randomhash12', 'user', 'free', NULL),
('Emre', 'Demir', 'emre@example.com', '$2a$10$randomhash13', 'user', 'premium', '2024-12-31'),
('Gizem', 'Arslan', 'gizem@example.com', '$2a$10$randomhash14', 'user', 'free', NULL),
('Hakan', 'Çelik', 'hakan@example.com', '$2a$10$randomhash15', 'user', 'premium', '2024-06-30'),
('Irem', 'Şahin', 'irem@example.com', '$2a$10$randomhash16', 'user', 'free', NULL),
('Jale', 'Öztürk', 'jale@example.com', '$2a$10$randomhash17', 'user', 'premium', '2024-09-30'),
('Kamil', 'Ak', 'kamil@example.com', '$2a$10$randomhash18', 'user', 'free', NULL),
('Leyla', 'Yılmaz', 'leyla@example.com', '$2a$10$randomhash19', 'user', 'premium', '2024-12-31'),
('Murat', 'Kaya', 'murat@example.com', '$2a$10$randomhash20', 'user', 'free', NULL),
('Naz', 'Demir', 'naz@example.com', '$2a$10$randomhash21', 'user', 'premium', '2024-06-30'),
('Omer', 'Arslan', 'omer@example.com', '$2a$10$randomhash22', 'user', 'free', NULL),
('Pinar', 'Çelik', 'pinar@example.com', '$2a$10$randomhash23', 'user', 'premium', '2024-09-30'),
('Rıza', 'Şahin', 'riza@example.com', '$2a$10$randomhash24', 'user', 'free', NULL),
('Selin', 'Öztürk', 'selin@example.com', '$2a$10$randomhash25', 'user', 'premium', '2024-12-31'),
('Tamer', 'Ak', 'tamer@example.com', '$2a$10$randomhash26', 'user', 'free', NULL),
('Umut', 'Yılmaz', 'umut@example.com', '$2a$10$randomhash27', 'user', 'premium', '2024-06-30'),
('Vildan', 'Kaya', 'vildan@example.com', '$2a$10$randomhash28', 'user', 'free', NULL),
('Yusuf', 'Demir', 'yusuf@example.com', '$2a$10$randomhash29', 'user', 'premium', '2024-09-30'),
('Zara', 'Arslan', 'zara@example.com', '$2a$10$randomhash30', 'user', 'free', NULL),
('Arda', 'Çelik', 'arda@example.com', '$2a$10$randomhash31', 'user', 'premium', '2024-12-31'),
('Buse', 'Şahin', 'buse@example.com', '$2a$10$randomhash32', 'user', 'free', NULL),
('Cagri', 'Öztürk', 'cagri@example.com', '$2a$10$randomhash33', 'user', 'premium', '2024-06-30'),
('Dilara', 'Ak', 'dilara@example.com', '$2a$10$randomhash34', 'user', 'free', NULL),
('Efe', 'Yılmaz', 'efe@example.com', '$2a$10$randomhash35', 'user', 'premium', '2024-09-30'),
('Feyza', 'Kaya', 'feyza@example.com', '$2a$10$randomhash36', 'user', 'free', NULL),
('Gokhan', 'Demir', 'gokhan@example.com', '$2a$10$randomhash37', 'user', 'premium', '2024-12-31'),
('Hazal', 'Arslan', 'hazal@example.com', '$2a$10$randomhash38', 'user', 'free', NULL),
('Ismail', 'Çelik', 'ismail@example.com', '$2a$10$randomhash39', 'user', 'premium', '2024-06-30'),
('Jade', 'Şahin', 'jade@example.com', '$2a$10$randomhash40', 'user', 'free', NULL),
('Kaya', 'Öztürk', 'kaya@example.com', '$2a$10$randomhash41', 'user', 'premium', '2024-09-30'),
('Lale', 'Ak', 'lale@example.com', '$2a$10$randomhash42', 'user', 'free', NULL),
('Mert', 'Yılmaz', 'mert@example.com', '$2a$10$randomhash43', 'user', 'premium', '2024-12-31'),
('Nur', 'Kaya', 'nur@example.com', '$2a$10$randomhash44', 'user', 'free', NULL),
('Onur', 'Demir', 'onur@example.com', '$2a$10$randomhash45', 'user', 'premium', '2024-06-30'),
('Pamir', 'Arslan', 'pamir@example.com', '$2a$10$randomhash46', 'user', 'free', NULL),
('Rukiye', 'Çelik', 'rukiye@example.com', '$2a$10$randomhash47', 'user', 'premium', '2024-09-30'),
('Sarp', 'Şahin', 'sarp@example.com', '$2a$10$randomhash48', 'user', 'free', NULL),
('Tugce', 'Öztürk', 'tugce@example.com', '$2a$10$randomhash49', 'user', 'premium', '2024-12-31'),
('Utku', 'Ak', 'utku@example.com', '$2a$10$randomhash50', 'user', 'free', NULL);

-- Create admin user with proper password hash
INSERT INTO users (first_name, last_name, email, password_hash, role, subscription_type, subscription_end_date) VALUES
('Admin', 'User', 'admin@example.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'premium', '2025-12-31');
